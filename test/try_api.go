...
// 	cfg.AddDefaultHeader("X-Finnhub-Token", "d526e39r01qu5pvmmfs0d526e39r01qu5pvmmfsg")
...
// 	// Bid ask
// 	lastBidAsk, _, err := finnhubClient.stock(context.Background()).Symbol("BRK.A").Execute()
// 	if err != nil {
// 		panic(err)
// 	}
// 	fmt.Printf("%+v\n", lastBidAsk)
// 	// lastBidAsk, _, err := finnhubClient.StockBidask(context.Background()).Symbol("BRK.A").Execute()
// 	// if err != nil {
// 	// 	panic(err)
// 	// }
// 	// fmt.Printf("%+v\n", lastBidAsk)
